...
(@) Click `Apply` → `OK` when you've finished editing the layer's symbology
...
The EPSG code for the British National Grid is `r forms_num(27700, tol = 50)`.

Which projection type preserves area? `r forms_string("equal-area")`
