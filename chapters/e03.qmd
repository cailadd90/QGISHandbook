...
(@) Add the `Wales_Principal_Areas.gpkg` layer to your project

(@) Add the `Wales_headcounts_at_postcodes_2021.gpkg` layer to your project. This dataset contains the number of households and people registered at each postcode (taken from the 2021 Census), combined with coordinates from OS OpenData
...
#| results: asis
library(exams2forms)
exams2forms("E03_Q1.Rmd", edir = "exercises")
```
...
#| results: asis
library(exams2forms)
exams2forms("E03_Q2.Rmd", edir = "exercises")
```
...
#| results: asis
library(exams2forms)
exams2forms("E03_Q3.Rmd", edir = "exercises")
```
...
#| results: asis
library(exams2forms)
exams2forms("E03_Q4.Rmd", edir = "exercises")
```
...
(@) Click `Run`. Results are presented under the `Log` tab, and can be viewed in the `Results Viewer`. Double-clicking `Statistics` will open the results in a web browser
...
#| results: asis
library(exams2forms)
exams2forms("E03_Q5.Rmd", edir = "exercises")
```
...
#| results: asis
library(exams2forms)
exams2forms("E03_Q6.Rmd", edir = "exercises")
```
...
## Selecting by location {#sec-selectlocation}
...
#| results: asis
library(exams2forms)
exams2forms("E03_Q7.Rmd", edir = "exercises")
```

(@) Calculate the 2021 population of Cardiff county
...
#| results: asis
library(exams2forms)
exams2forms("E03_Q8.Rmd", edir = "exercises")
```

(@) Calculate the percentage population change in Swansea county between 2011 and 2021. Show off again by beating your neighbour in finding the results
...
#| results: asis
library(exams2forms)
exams2forms("E03_Q9.Rmd", edir = "exercises")
```

## Creating a heatmap

(@) Click `Processing` → `Toolbox` or find the the shortcut (![](figs/ProcessingToolbox.png){width=3%})
...
## Exporting vector layers {#sec-export}
...
## Using buffers as simple catchments {#sec-buffers}
...
(@) For the final challenge - find the total number of people registered in 2021 within 2 km of Swansea University Singleton Campus (SA2 8PQ) and Bay Campus (SA1 8QE). Hint: see @sec-filter
...
#| results: asis
library(exams2forms)
exams2forms("E03_Q10.Rmd", edir = "exercises")
```
